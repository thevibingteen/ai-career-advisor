...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 👉 If you still get 404, try: "gemini-1.5-pro" or "gemini-1.5-flash"
...
Name: ${userData.name}, Skills: ${userData.skills}, Experience: ${userData.experience}, Interests: ${(userData.interests || []).join(
    ", "
  ...
  return [
    {
      ...
      match: 85,
      description:
        "This is a sample response because the AI is currently unavailable.",
    ...
    },
    {
      ...
      match: 65,
      description:
        "Create user-friendly interfaces that provide meaningful experiences to users.",
